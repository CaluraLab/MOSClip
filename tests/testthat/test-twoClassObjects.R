test_that("Two Class Pathway Test works", {
  ...
  expect_error(multiOmicsTwoClassPathwayTest(dummy_Omics, dummy_react[[1]],
                                             test_annot,
                                             baseFormula = "classes ~",
                                             nullModel = "classes ~ 1"), 
  ...
  expect_error(multiOmicsTwoClassPathwayTest(test_mo, dummy_react[[1]],
                                             dummy_annot,
                                             baseFormula = "classes ~",
                                             nullModel = "classes ~ 1"),
...
test_that("Two Class Module Test works", {
  ...
  expect_error(multiOmicsTwoClassModuleTest(dummy_Omics, genes,
                                            dummy_annot,
                                            baseFormula = "classes ~",
                                            nullModel = "classes ~ 1"),
