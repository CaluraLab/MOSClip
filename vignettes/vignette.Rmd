...
```{r}
multiOmics <- Omics(experiments = ExperimentList(list(expr = pseudoExpNorm,
...
g <- reactUsed[[1]]
g_modules <- multiOmicsSurvivalModuleTest(multiOmics, g, useThisGenes = genesToConsider)
g_pathway <- multiOmicsSurvivalPathwayTest(multiOmics, g, useThisGenes = genesToConsider)

g_modules@modulesView[[1]] # omics oververview
g_modules@usedGenes
names(g_modules@modulesView[[1]][[1]]) # omic summary (x, sdev, loadings, dataModule, method, namesCov, omicName")
names(g_modules@modulesView[[1]][[2]]) # omics summary ("x, dataModule, namesCov, cls, method, omicName")

g_pathway@pathView[[1]] # omics oververview
paste(names(g_pathway@pathView[[1]]), collapse = ", ") # x, sdev, loadings, dataModule, method, namesCov, omicName
