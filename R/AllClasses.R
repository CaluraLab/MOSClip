...
#' @slot log a list of the warning and/or error messages generated 
#' by `glm` or `cox` for each module.
...
#' @slot title the name of the pathway.
#' @slot analysis the type of analysis done: survival or two-class.
#' @slot log warning and/or error messages generated by `glm` or `cox`
...
setClass(
    Class = "MultiOmicsPathway", slots = c(
        ...
        title = "characterOrNULL", log = "characterOrNULL"
    )
)
